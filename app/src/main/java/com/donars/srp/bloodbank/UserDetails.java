...
import com.donars.srp.bloodbank.model.*;
...
public class UserDetails extends AppCompatActivity{
    ...
    TextView _lastd;
    @BindView(R.id.input_drinking)
    TextView _drink;
    @BindView(R.id.input_age)
    TextView _age;
    @BindView(R.id.input_ndonations)
    TextView _ndonations;
...
//                res="";
                ...
                if(res.length()>0 && !(res.equalsIgnoreCase("Failure"))) {
                    ...
                    try {
                        Gson gson = new Gson();
                        Details.userinfo = gson.fromJson(res, com.donars.srp.bloodbank.model.UserStats.class);
