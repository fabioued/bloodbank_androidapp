...
public class InfoFragment extends Fragment {
   ...
   // private OnFragmentInteractionListener mListener;
    ...
    public void init()
    {
        ...
        _nameText.setText( Details.hospital.getName());
        _emailText.setText(Details.hospital.getUsername());
        _address.setText(Details.hospital.getAddress());
        _nameCheifDoc.setText(Details.hospital.getChiefdoctor());
        _phoneNo.setText(Details.hospital.getPhone());
    }
    @Override
